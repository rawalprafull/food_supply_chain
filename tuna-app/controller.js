	...
	add_record:async  function(req, res){
		...
		var Pstatus = "New";
                ...
                try {
 	                    ...
 	                    const result  =  await contract.submitTransaction('addRecord', key, vessel, Rstatus, timestamp, deviceId ,location , price,supplier,distributor);
  ...
  get_record:async function(req, res){
	...
	change_status:async  function(req, res){
		...
		console.log("changing holder of tuna catch: " + recordStatus);
		  ...
		  try {
                            ...
                            const result = await contract.submitTransaction('updateRecordStatus',key, recordStatus);
                            console.log('Transaction has been submitted');
                            console.log(JSON.parse(result.toString()));
	...
	sent_item: async function(req, res){
		...
		senttimestamp = senttimestamp.replace(/_/g,'-');	
	           ...
	           try {
                            ...
                            const result = await contract.submitTransaction('updateShipmentSentStatus',key,shipmentid ,shipmentstatus,senttimestamp);
                            console.log('Transaction has been submitted');
	...
	receive_item: async function(req, res){
		...
		try {
                  ...
                  const result = await contract.submitTransaction('updateShipmentReceiveStatus', key,shipmentid,shipmentstatus,shipmentreceivetimestamp);
                  console.log('Transaction has been submitted');
		  console.log(result.toString());
